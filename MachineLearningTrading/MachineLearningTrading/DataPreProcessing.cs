...
{  
    ...
    public class DataPreProcessing
    {
        ...
        {   
            ...
            var delay_1 = Features.GetRowAt<double>(row_length-1);
            var delay_2 = Features.GetRowAt<double>(row_length-2);
            var delay_3 = Features.GetRowAt<double>(row_length-3);
            ...
            for (int i = 0; i < col_length; i++)
            {
                features_pred[i+col_length] = delay_2.GetAt(i);
            }
            for (int i = 0; i < col_length; i++)
            {
                features_pred[i+col_length*2] = delay_3.GetAt(i);
            }
